...
npm run deploy   # Deploy /out to GitHub Pages via gh-pages
```
...
The app is configured for **static export** (`output: "export"` in `next.config.mjs`), deployed to GitHub Pages at the `/mydokkan` subpath.
